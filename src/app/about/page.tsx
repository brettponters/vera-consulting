...
export const metadata: Metadata = {
  ...
  description:
    "VERA is an intelligence partner for real estate wholesalers, investors, and agents. We find off-market deals and motivated seller leads, and we only earn when you close. Based in Boca Raton, FL.",
