    ...
    >
      <Container size="wide">
        <div className="flex items-center gap-8">
          ...
          {/* Scrolling strip */}
          <Marquee duration={60} pauseOnHover className="flex-1">
            <span className="font-sans font-medium text-lg text-[var(--color-body)] whitespace-nowrap px-6">
              AI Training
              <span className="mx-4 text-[var(--color-muted)]">·</span>
              AI Agents
              <span className="mx-4 text-[var(--color-muted)]">·</span>
              Compliance
              <span className="mx-4 text-[var(--color-muted)]">·</span>
