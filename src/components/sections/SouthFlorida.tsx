...
const ROWS: AreaRow[] = [
  ...
  })),
  {
    ...
    blurb:
      "Not in South Florida? Most of the work runs over Google Meet, so we work with firms anywhere in the country.",
    href: "/contact",
  },
];
      ...
      <Container size="wide">
        <div className="pt-16 md:pt-20">
          <div className="max-w-[720px] space-y-5 mb-10 md:mb-14">
            ...
            >
              Based in Boca Raton. Working with firms across the United States.
            </h2>
